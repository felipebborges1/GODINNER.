...
export function RecommendationSection({ result }: { result: RecommendationResult }) {
  ...
  if (maturity === "locked") {
    ...
    return <section ref={sectionRef} id="recommendations" aria-labelledby="recommendations-heading" className="mt-10 scroll-mt-6 rounded-3xl border border-stone-200 bg-stone-50 p-5 sm:p-6">
