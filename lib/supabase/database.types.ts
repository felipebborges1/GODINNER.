...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      publish_review_with_rating_details: { Args: { p_restaurant_id: string; p_rating_details: unknown; p_comment: string; p_amount_per_person: number | null; p_visit_date: string; p_photos: Array<{ storage_path: string; position: number }>; p_publication_key: string | null }; Returns: Array<{ review_id: string; recommendations_unlocked: boolean }> };
      ...
      update_review_with_rating_details_owned: { Args: { p_review_id: string; p_rating_details: unknown; p_comment: string; p_amount_per_person: number | null; p_visit_date: string; p_photos: Array<{ storage_path: string; position: number }> }; Returns: Array<{ review_id: string; updated_at: string; removed_paths: string[] }> };
...
export type ReviewCommentRow = { id: string; review_id: string; user_id: string; body: string; parent_comment_id: string | null; reply_to_comment_id: string | null; created_at: string; updated_at: string; };
