...
import { InfiniteFeedSentinel } from "@/components/feed/infinite-feed-sentinel";
...
import { dedupeReviewsById, nextFeedVisibleCount, orderReviewsForFeed } from "@/lib/feed-pagination";
...
export default function FeedPage() {
  ...
  const loadNextPage = useCallback(() => setVisibleCount((current) => nextFeedVisibleCount(current, activities.length, FEED_PAGE_SIZE)), [activities.length]);
