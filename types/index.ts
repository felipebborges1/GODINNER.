...
export interface Review { id: string; userId: string; restaurantId: string; rating: number; legacyRating: number | null; ratingMethod: ReviewRatingMethod; foodRating: number | null; serviceRating: number | null; ambienceRating: number | null; comment: string; photos: RestaurantPhoto[]; amountPerPerson?: number; visitDate: string; createdAt: string; }
