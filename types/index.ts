...
export interface Restaurant { id: string; slug: string; name: string; cuisine: string[]; tags: string[]; category: "restaurant" | "bar"; chef: string; occasions: string[]; isOpenNow: boolean; distanceKm: number; coordinates?: RestaurantCoordinates; priceRange: PriceRange | null; neighborhood: string; city: string; address: string; countryCode?: string; acceptsDuoGourmet?: boolean; duoGourmetCheckedAt?: string; godinnerRating: number; friendsRating: number; reviewCount: number; coverPhoto: RestaurantPhoto; photos: RestaurantPhoto[]; hasGooglePlaceCover?: boolean; googlePlaceId?: string; status?: "published" | "pending_review" | "rejected"; submittedBy?: string; submittedAt?: string; instagram?: string; site?: string; phone?: string; moderatedBy?: string; moderatedAt?: string; rejectionReason?: string; mergedIntoId?: string; }
